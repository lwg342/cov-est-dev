...
\begin{document}
    ...
    \section{Introduction and Literature Review}\input{model.tex}
    \section{Literature Review}\input{literature-review.tex}
    \section{Estimator and Convergence Rate}\input{theory.tex}
    \section{Simulations}\input{simulation.tex} 
    \section{Empirical Studies}\input{empirical.tex}
    \section{Conclusion and Further Works}\input{conclud.tex}
